...
IF OBJECT_ID('dbo.laptop_parts', 'U') IS NOT NULL 
  DROP TABLE dbo.laptop_parts; 
...
(
  id_ltp_part INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
  id_ltp VARCHAR(10) NOT NULL,
  id_param INT NOT NULL,
  name VARCHAR(50) NOT NULL,
  is_duplicity_error BIT NOT NULL,
  is_part_error BIT NOT NULL,
  is_pair_error BIT NOT NULL,
  FOREIGN KEY (id_ltp) REFERENCES laptops(id_ltp),
